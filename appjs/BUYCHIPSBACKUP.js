...
function Nagadtrxidfilterdirectby(str){
	...
	// Load Payment numbe and Chip price //	
var loaPaymentNumber_nagad_personal =  function(amount_cr){
...
var loaPaymentNumber_nagad_payment =  function(amount_cr){
...
document.addEventListener('init', function(event) {
  ...
  if (event.target.matches('#buy_chips')) {
  	  ...
  	  if (event.target.matches('#direct_gift_buy')) {
		...
		$("#direct_buy_first").one('submit',function(e) {
				e.preventDefault(); // avoid to execute the actual submit of the form.
					...
					var data = {data: {title: 'Buy Chips',playerid:playerid,direct_buy_amount:direct_buy_amount}}
	 ...
	 if (event.target.matches('#direct_gift_bkash_paymentoption_personal')) {
			var direct_buy_playerid = sessionStorage.getItem('direct_buy_playerid');		
			var direct_buy_amount = sessionStorage.getItem('direct_buy_amount');		
			loaPaymentNumber_personal(direct_buy_amount);
	  }
	  
	  
	  if (event.target.matches('#direct_gift_bkash_paymentoption_payment')) {
			var direct_buy_amount = sessionStorage.getItem('direct_buy_amount');		
			loaPaymentNumber_payment(direct_buy_amount);
	  }
	  
// 	  
	  if (event.target.matches('#direct_gift_nagad_paymentoption_personal')) {
			var direct_buy_amount = sessionStorage.getItem('direct_buy_amount');		
			loaPaymentNumber_nagad_personal(direct_buy_amount);
	  }
	  
	   if (event.target.matches('#direct_gift_nagad_paymentoption_payment')) {
			var direct_buy_amount = sessionStorage.getItem('direct_buy_amount');		
			loaPaymentNumber_nagad_payment(direct_buy_amount);
	  }
	  
	  	if(event.target.matches('#direct_gift_nagad_paymentconfirm_personal')) {
	  ...
	  if(event.target.matches('#direct_gift_nagad_paymentconfirm_payment')) {
